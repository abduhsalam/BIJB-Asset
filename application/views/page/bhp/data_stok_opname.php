...
<div class="row-fluid">
	<div class="span12"> 
	<form id="form-tbh-asset" class="form-horizontal" action="<?php echo base_url(); ?>Bhp/data_stok_opname" method="post">
		<div class="row-fluid">
			<div class="span6">					
