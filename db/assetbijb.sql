...
--
-- Table structure for table `bhp_kodemanual`
--
...
--
-- Table structure for table `bhp_master`
--
...
--
-- Table structure for table `bhp_pengajuan`
--
...
--
-- Table structure for table `bhp_pengajuandetail`
--
...
CREATE TABLE IF NOT EXISTS `bhp_pengajuandetail` (
  ...
  `status` char(20) DEFAULT NULL,
  `keterangan` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id_pengajuandet`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `bhp_satuanbarang`
--
...
--
-- Table structure for table `bhp_stok`
--
...
--
-- Table structure for table `bhp_stokopname`
--
...
--
-- Table structure for table `bhp_transaksi`
--
...
CREATE TABLE IF NOT EXISTS `bhp_transaksi` (
  ...
  `tgl_input` date DEFAULT NULL,
  `user_input` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_transaksiphb`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ma_jenisasset`
--

CREATE TABLE IF NOT EXISTS `ma_jenisasset` (
  `kode_jenisasset` char(20) NOT NULL DEFAULT '',
  `nama_jenisasset` char(100) DEFAULT NULL,
  PRIMARY KEY (`kode_jenisasset`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_jenisasset`
--

INSERT INTO `ma_jenisasset` (`kode_jenisasset`, `nama_jenisasset`) VALUES
('JA-1', 'PERALATAN'),
('JA-2', 'KENDARAAN'),
('JA-3', 'TANAH DAN BANGUNAN');

-- --------------------------------------------------------

--
-- Table structure for table `ma_jenispajak`
--

CREATE TABLE IF NOT EXISTS `ma_jenispajak` (
  `kode_jnspajak` char(20) NOT NULL DEFAULT '',
  `nama_jnspajak` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`kode_jnspajak`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_jenispajak`
--
...
--
-- Table structure for table `ma_jenispenyedia`
--
...
CREATE TABLE IF NOT EXISTS `ma_jenispenyedia` (
  ...
  PRIMARY KEY (`kode_jnspenyedia`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_jenispenyedia`
--
...
--
-- Table structure for table `ma_jenisperlakuan`
--
...
CREATE TABLE IF NOT EXISTS `ma_jenisperlakuan` (
  ...
  PRIMARY KEY (`kode_jnsperlakuan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_jenisperlakuan`
--
...
--
-- Table structure for table `ma_kategoriasset`
--
...
--
-- Dumping data for table `ma_kategoriasset`
--

INSERT INTO `ma_kategoriasset` (`kode_kategori`, `kode_jenisasset`, `nama_kategori`) VALUES
('KT-1', 'JA-1', 'ELEKTRONIK'),
('KT-2', 'JA-1', 'FURNITURE'),
('KT-3', 'JA-2', 'RODA DUA'),
('KT-4', 'JA-2', 'RODA EMPAT');

-- --------------------------------------------------------

--
-- Table structure for table `ma_kondisiasset`
--
...
CREATE TABLE IF NOT EXISTS `ma_kondisiasset` (
  ...
  PRIMARY KEY (`kode_kondisiasset`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_kondisiasset`
--
...
--
-- Table structure for table `ma_namabarang`
--
...
--
-- Dumping data for table `ma_namabarang`
--

INSERT INTO `ma_namabarang` (`kode_barang`, `kode_kategori`, `nama_barang`) VALUES
('BRG-1', 'KT-1', 'LAPTOP'),
('BRG-2', 'KT-1', 'PC'),
('BRG-3', 'KT-1', 'PRINTER'),
('BRG-4', 'KT-2', 'MEJA'),
('BRG-5', 'KT-2', 'LEMARI'),
('BRG-6', 'KT-3', 'SEPEDA MOTOR'),
('BRG-7', 'KT-4', 'MOBIL DINAS');

-- --------------------------------------------------------

--
-- Table structure for table `ma_sequence`
--
...
--
-- Table structure for table `ma_sumberanggaran`
--
...
CREATE TABLE IF NOT EXISTS `ma_sumberanggaran` (
  ...
  PRIMARY KEY (`kode_sumberanggaran`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ma_sumberanggaran`
--
...
--
-- Table structure for table `ma_vendor`
--
...
--
-- Dumping data for table `ma_vendor`
--
...
--
-- Table structure for table `ta_asset`
--
...
--
-- Dumping data for table `ta_asset`
--

INSERT INTO `ta_asset` (`id_asset`, `kode_asset`, `kode_pengajuan`, `kode_jenisasset`, `kode_kategori`, `kode_namabarang`, `merk_asset`, `tgl_pembelian`, `spesifikasi`, `jumlah`, `harga`, `awal_garansi`, `akhir_garansi`, `kode_vendor`, `img_objek`, `img_kelengkapan`, `kelengkapan`, `keterangan`, `status`, `kondisi_asset`, `kepemilikan_asset`, `aktif`, `user_input`, `tgl_input`) VALUES
('20180111009', '18.01-3-1.1.1-1', NULL, 'JA-1', 'KT-1', 'BRG-1', 'asus', '2018-01-11', 'test', 1, 8000000, '2018-01-11', '2018-01-11', 'VDR-21', '20180111009_obj.png', '20180111009_klp.jpg', 'tas laptop', '-', 'TERSEDIA', 'LAYAK', 'PERUSAHAAN', 'YES', 66, '2018-01-11');

-- --------------------------------------------------------

--
-- Table structure for table `ta_assetkendaraan`
--
...
CREATE TABLE IF NOT EXISTS `ta_assetkendaraan` (
  ...
  `user_input` int(11) DEFAULT NULL,
  `tgl_input` date DEFAULT NULL,
  PRIMARY KEY (`id_assetkendaraan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_assettnhbgn`
--
...
CREATE TABLE IF NOT EXISTS `ta_assettnhbgn` (
  ...
  `keterangan` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id_assettnhbgn`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_barcodeasset`
--
...
--
-- Dumping data for table `ta_barcodeasset`
--

INSERT INTO `ta_barcodeasset` (`id_barcode`, `kode_asset`, `status`) VALUES
('201805041', '18.01-3-1.1.1-1', 'TERSEDIA');

-- --------------------------------------------------------

--
-- Table structure for table `ta_distribusiasset`
--
...
--
-- Table structure for table `ta_kirkendaraan`
--
...
CREATE TABLE IF NOT EXISTS `ta_kirkendaraan` (
  ...
  `user_input` int(11) DEFAULT NULL,
  `tgl_input` date DEFAULT NULL,
  PRIMARY KEY (`id_kirkendaraan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_maintenkendaraan`
--
...
CREATE TABLE IF NOT EXISTS `ta_maintenkendaraan` (
  ...
  `user_input` int(11) DEFAULT NULL,
  `tgl_input` date DEFAULT NULL,
  PRIMARY KEY (`id_maintenkendaraan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_pajakkendaraan`
--
...
CREATE TABLE IF NOT EXISTS `ta_pajakkendaraan` (
  ...
  `user_input` int(11) DEFAULT NULL,
  `tgl_input` date DEFAULT NULL,
  PRIMARY KEY (`id_pjkkendaraan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_pajaktnhbgn`
--
...
CREATE TABLE IF NOT EXISTS `ta_pajaktnhbgn` (
  ...
  `user_input` int(11) DEFAULT NULL,
  `tgl_input` date DEFAULT NULL,
  PRIMARY KEY (`id_pjktnhbgn`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_pemakaiankendaraan`
--
...
--
-- Table structure for table `ta_peminjamanasset`
--
...
--
-- Table structure for table `ta_pengajuanasset`
--
...
--
-- Table structure for table `ta_perlakuanasset`
--
...
CREATE TABLE IF NOT EXISTS `ta_perlakuanasset` (
  ...
  `tgl_input` date DEFAULT NULL,
  `user_input` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_perlakuan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `ta_sewaasset`
--
...
--
-- Table structure for table `ta_stokopname`
--
...
--
-- Table structure for table `ta_tglstokopname`
--
...
--
-- Table structure for table `temp_assetopname`
--
...
--
-- Table structure for table `temp_bhpopname`
--
